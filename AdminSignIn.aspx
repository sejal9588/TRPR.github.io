<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminSignIn.aspx.cs" Inherits="TRPR.AdminSignIn" %>
		...
		<div class="modal-content animate">
			...
			<div class="container">
				...
				<div class="input-container">
					...
					<asp:TextBox ID="txtEICConfirm" Placeholder="Enter Confirm Password" TextMode="Password" runat="server" required></asp:TextBox>
				</div>
				<asp:Label ID="lblMessage" runat="server" Text=""></asp:Label>
				<asp:Button ID="btnEICRegister" runat="server" class="btnsub" Text="Register" OnClick="btnEICRegister_Click" />
				<br />
				<label>
				...
				<asp:LinkButton ID="lbLoginHere" runat="server" Style="text-decoration: underline; color: white;" OnClick="lbLoginHere_Click">Login here</asp:LinkButton>
			</div>
